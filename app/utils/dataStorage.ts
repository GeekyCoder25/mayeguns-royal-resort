...
export const membershipLevel = [
	{
		...
		content: [
			'Exclusive access to the penthouse, health and all other state of the arts facilities',
			...
			'7 days accessibility to our prestigious and elegant room, maximum stay is 5 days only monthly',
